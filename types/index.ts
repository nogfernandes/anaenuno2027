...
export interface WeddingSettings { rsvp_open:boolean; rsvp_deadline:string; pre_event_rsvp_open:boolean; pre_event_rsvp_deadline:string; show_pre_event:boolean; show_faq:boolean; show_dress_code:boolean; show_playlist:boolean; show_public_playlist:boolean; playlist_display_mode:'list'|'cloud'; show_programme:boolean; header_show_story:boolean; header_show_programme:boolean; header_show_wedding_rsvp:boolean; header_show_faq:boolean; header_show_dress_code:boolean; header_show_playlist:boolean; header_show_pre_event:boolean; }
